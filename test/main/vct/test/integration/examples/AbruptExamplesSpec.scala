...
class AbruptExamplesSpec extends VercorsSpec {
  ...
  // Technical examples
  vercors should error withCode "resolutionError:redundantCatchClause" example "concepts/abrupt/CatchTypesIdenticalBad.java"
  vercors should error withCode "resolutionError:redundantCatchClause" example "concepts/abrupt/CatchTypesSubtypeBad.java"
  ...
  vercors should error withCode "resolutionError:resultOutsidePostcondition" example "concepts/abrupt/NoResultInSignals.java"
  ...
  vercors should error withCode "resolutionError:type" example "concepts/abrupt/ThrowIntBad.java"
  vercors should verify using anyBackend example "concepts/abrupt/ThrowsAndThrow.java"
  vercors should error withCode "resolutionError:type" example "concepts/abrupt/TypecheckSignalsBad.java"
