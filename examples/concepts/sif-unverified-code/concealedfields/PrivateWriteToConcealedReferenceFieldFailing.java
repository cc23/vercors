...
class PrivateWriteToConcealedReferenceField {
    ...
    public void main(boolean secret) {
        ...
        //insecure, since low(highD) doesnt hold
        // -> without this precondition this attack would leak the secret boolean
        highD.concealedToNonConcealedPublic();
    }
}
